                ...
                <div class="w-full md:w-1/4 bg-white p-4 rounded-lg shadow-md text-center">
                    ...
                    <div class="relative w-32 h-32 mx-auto mb-4">
                        ...
                        <label for="avatar-upload"
                            class="absolute -bottom-2 -right-2 bg-gray-700 text-white p-2 rounded-full cursor-pointer shadow-lg">
                    ...
                    <div class="mt-4">
                        <form action="<?php echo e(route('logout')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <button type="submit"
                                class="w-full text-center p-3 text-red-600 border border-red-600 rounded-lg hover:bg-red-100">
                                Đăng Xuất
                            </button>
                        </form>
                    </div>
                            ...
                            <div class="flex space-x-2 mt-4">
                                ...
                                <?php if(Auth::user()->role === 'admin' || Auth::user()->role === 'moderator'): ?>
                                    <a href="<?php echo e(route('admin.dashboard')); ?>"
                                        class="bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 admin-btn">
                                        Đăng nhập Admin
                                    </a>
                                <?php endif; ?>
                            </div>
                        ...
                        <form action="<?php echo e(route('profile.updatePassword')); ?>" method="POST"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="password" name="current_password"
                                    class="w-full p-2 border rounded <?php $__errorArgs = ['current_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="password" name="new_password"
                                    class="w-full p-2 border rounded <?php $__errorArgs = ['new_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
