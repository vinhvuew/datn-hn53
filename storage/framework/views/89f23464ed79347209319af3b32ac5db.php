    ...
    <div class="max-w-5xl w-full mx-auto p-4">
        <div class="flex flex-col md:flex-row">
            ...
            <div class="w-full md:w-1/4 bg-white p-4 border border-gray-300 rounded-lg shadow-md">
                ...
                <p class="text-lg font-semibold text-center"><?php echo e(Auth::user()->name); ?></p>
                    ...
                    <div class="bg-gray-100 p-4 rounded-lg border border-gray-300">
                        ...
                        <div class="flex space-x-2 mt-4">
                            ...
                            <?php if(Auth::user()->role === 'admin' || Auth::user()->role === 'moderator'): ?>
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 admin-btn">
                                    Đăng nhập Admin
                                </a>
                ...
                <div id="info-form" class="hidden content-box">
                    ...
                    <form action="<?php echo e(route('profile.update')); ?>" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" name="name" value="<?php echo e(Auth::user()->name); ?>" class="w-full p-2 border border-gray-300 rounded-lg">
                        </div>
                        <div class="mb-4">
                            <label for="email" class="block text-gray-700">Email:</label>
                            <input type="email" id="email" name="email" value="<?php echo e(Auth::user()->email); ?>" class="w-full p-2 border border-gray-300 rounded-lg">
                        </div>
                        <div class="mb-4">
                            <label for="phone" class="block text-gray-700">Số điện thoại:</label>
                            <input type="text" id="phone" name="phone" value="<?php echo e(Auth::user()->phone); ?>" class="w-full p-2 border border-gray-300 rounded-lg">
                        </div>
