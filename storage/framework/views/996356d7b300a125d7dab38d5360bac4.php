<?php $__env->startSection('content'); ?>
    <main>
        ...
        <?php echo $__env->make('client.layouts.parials.banner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="grid_item">
                        <figure>
                            ...
                            <a href="product-detail-1.html">
                                ...
                                <img class="img-fluid lazy" src="client/img/products/product_placeholder_square_medium.jpg"
                                    data-src="client/img/products/shoes/1_b.jpg" alt="" width="400"
                                    height="400">
                            </a>
                    ...
                    <div class="grid_item">
                        ...
                        <figure>
                            <a href="product-detail-1.html">
                                ...
                                <img class="client/img-fluid lazy" src="img/products/product_placeholder_square_medium.jpg"
                                    data-src="client/img/products/shoes/2_b.jpg" alt="" width="400"
                                    height="400">
                            </a>
                ...
                <div class="col-6 col-md-4 col-xl-3">
                    <div class="grid_item">
                        ...
                        <figure>
                            <a href="product-detail-1.html">
                                <img class="img-fluid lazy" src="client/img/products/product_placeholder_square_medium.jpg"
                                    data-src="client/img/products/shoes/2.jpg" alt="" width="400"
                                    height="400">
                                <img class="client/img-fluid lazy"
                        ...
                        <figure>
                            <a href="product-detail-1.html">
                                <img class="owl-lazy img-fluid"
                                    src="client/img/products/product_placeholder_square_medium.jpg"
                                    data-src="client/img/products/shoes/4.jpg" alt="" width="400"
                                    height="400">
                            </a>
                        </figure>
                        <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i
                    ...
                    <div class="grid_item">
                        ...
                        <figure>
                            <a href="product-detail-1.html">
                                <img class="owl-lazy img-fluid"
                                    src="client/img/products/product_placeholder_square_medium.jpg"
                                    data-src="client/img/products/shoes/5.jpg" alt="" width="400"
                                    height="400">
                            </a>
                        </figure>
                        <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i
...
<?php echo $__env->make('client.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\datn-hn53\resources\views/client/index.blade.php ENDPATH**/ ?>