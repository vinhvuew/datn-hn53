    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="app-ecommerce-category">
            ...
            <div class="card mb-4">
                ...
                <?php endif; ?>
                <div class="card-body">
                    <form action="<?php echo e(route('attribute-values.update', $value->id)); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="value" id="value" class="form-control"
                                placeholder="Nhập giá trị" value="<?php echo e($value->value); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\datn-hn53\resources\views/admin/attribute_values/edit.blade.php ENDPATH**/ ?>