...
<link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="{{ asset('client') }}/img/logo114x114.png">
<link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="{{ asset('client') }}/img/logo144x144.png">
