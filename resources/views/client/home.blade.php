                        ...
                        <figure>
                            ...
                            <a href="product-detail-1.html">
                                <img class="img-fluid lazy"
                                    ...
                                    data-src="{{ asset('client') }}/img/products/shoes/1.jpg" alt="" width="400"
                                    height="400">
                                <img class="img-fluid lazy"
                                    src="{{ asset('client') }}/img/products/product_placeholder_square_medium.jpg"
                                    data-src="{{ asset('client') }}/img/products/shoes/1_b.jpg" alt=""
                    ...
                    <div class="grid_item">
                        ...
                        <figure>
                            <a href="product-detail-1.html">
                                ...
                                <img class="img-fluid lazy"
                                    src="{{ asset('client') }}/img/products/product_placeholder_square_medium.jpg"
                                    data-src="{{ asset('client') }}/img/products/shoes/2_b.jpg" alt=""
                                    width="400" height="400">
                            </a>
                    ...
                    <div class="grid_item">
                        ...
                        <figure>
                            <a href="product-detail-1.html">
                                ...
                                <img class="img-fluid lazy"
                                    src="{{ asset('client') }}/img/products/product_placeholder_square_medium.jpg"
                                    data-src="{{ asset('client') }}/img/products/shoes/3_b.jpg" alt=""
                                    width="400" height="400">
                            </a>
                    ...
                    <div class="grid_item">
                        ...
                        <figure>
                            <a href="product-detail-1.html">
                                ...
                                <img class="img-fluid lazy"
                                    src="{{ asset('client') }}/img/products/product_placeholder_square_medium.jpg"
                                    data-src="{{ asset('client') }}/img/products/shoes/4_b.jpg" alt=""
                                    width="400" height="400">
                            </a>
                        </figure>
                        <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i
                    ...
                    <div class="grid_item">
                        ...
                        <figure>
                            <a href="product-detail-1.html">
                                ...
                                <img class="img-fluid lazy"
                                    src="{{ asset('client') }}/img/products/product_placeholder_square_medium.jpg"
                                    data-src="{{ asset('client') }}/img/products/shoes/5_b.jpg" alt=""
                                    width="400" height="400">
                            </a>
                        </figure>
                        <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i
                    ...
                    <div class="grid_item">
                        ...
                        <figure>
                            <a href="product-detail-1.html">
                                ...
                                <img class="img-fluid lazy"
                                    src="{{ asset('client') }}/img/products/product_placeholder_square_medium.jpg"
                                    data-src="{{ asset('client') }}/img/products/shoes/6_b.jpg" alt=""
                                    width="400" height="400">
                            </a>
                        </figure>
                        <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i
                    ...
                    <div class="grid_item">
                        ...
                        <figure>
                            <a href="product-detail-1.html">
                                ...
                                <img class="img-fluid lazy"
                                    src="{{ asset('client') }}/img/products/product_placeholder_square_medium.jpg"
                                    data-src="{{ asset('client') }}/img/products/shoes/7_b.jpg" alt=""
                                    width="400" height="400">
                            </a>
                        </figure>
                        <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i
                    ...
                    <div class="grid_item">
                        ...
                        <figure>
                            <a href="product-detail-1.html">
                                ...
                                <img class="img-fluid lazy"
                                    src="{{ asset('client') }}/img/products/product_placeholder_square_medium.jpg"
                                    data-src="{{ asset('client') }}/img/products/shoes/8_b.jpg" alt=""
                                    width="400" height="400">
                            </a>
                        </figure>
                        <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i
        ...
        <div class="bg_gray">
            <div class="container margin_30">
                <div id="brands" class="owl-carousel owl-theme">
                    ...
                    <div class="item">
                        <a href="#0"><img src="{{ asset('client') }}/img/brands/placeholder_brands.png"
                                data-src="{{ asset('client') }}/img/brands/logo_2.png" alt=""
                                class="owl-lazy"></a>
                    </div>
                    <!-- /item -->
                    <div class="item">
                        <a href="#0"><img src="{{ asset('client') }}/img/brands/placeholder_brands.png"
                                data-src="{{ asset('client') }}/img/brands/logo_3.png" alt=""
                                class="owl-lazy"></a>
                    </div>
                    <!-- /item -->
                    <div class="item">
                        <a href="#0"><img src="{{ asset('client') }}/img/brands/placeholder_brands.png"
                                data-src="{{ asset('client') }}/img/brands/logo_4.png" alt=""
                                class="owl-lazy"></a>
                    </div>
                    <!-- /item -->
                    <div class="item">
                        <a href="#0"><img src="{{ asset('client') }}/img/brands/placeholder_brands.png"
                                data-src="{{ asset('client') }}/img/brands/logo_5.png" alt=""
                                class="owl-lazy"></a>
                    </div>
                    <!-- /item -->
                    <div class="item">
                        <a href="#0"><img src="{{ asset('client') }}/img/brands/placeholder_brands.png"
                                data-src="{{ asset('client') }}/img/brands/logo_6.png" alt=""
                                class="owl-lazy"></a>
                    </div>
                    <!-- /item -->
                </div>
