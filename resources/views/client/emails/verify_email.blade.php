...
<body class="bg-light d-flex justify-content-center align-items-center vh-100">
    ...
    <div class="card text-center shadow p-4" style="max-width: 400px;">
        <div class="card-body">
            <h4 class="card-title">Chào {{ $user->name }},</h4>
            <p class="card-text">Mã xác thực của bạn là:</p>
            <h2 class="fw-bold text-primary">{{ $user->verification_code }}</h2>
            <p>Mã này sẽ hết hạn sau 5 phút.</p>
            <p class="mt-3">Vui lòng nhập mã này vào trang xác thực để kích hoạt tài khoản.</p>
            <a href="{{ route('verification.form') }}" class="btn btn-primary mt-3">Nhập mã xác thực</a>
        </div>
    </div>
