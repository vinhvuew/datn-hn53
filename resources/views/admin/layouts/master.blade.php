                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{url('/admin/list-product')}}" class="menu-link">
                                    <div class="text-truncate" data-i18n="List Product">
                                       list product
                                    </div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{url('/admin/add-product')}}" class="menu-link">
                                    <div class="text-truncate" data-i18n="Add Product">
                                       add product
                                    </div>
                                </a>
...
<!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Jan 2024 15:24:14 GMT -->
