                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p class="mb-4">
                                    You have done
                                    <span class="fw-medium">72%</span>nhiều doanh số hơn hôm nay. Kiểm tra
                                    huy hiệu mới của bạn trong hồ sơ của bạn.
                                </p>

                                <a href="javascript:;" class="btn btn-sm btn-label-primary">Xem
                                    Huy hiệu</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body pb-0">
                                <span class="d-block fw-medium mb-1">Đặt hàng</span>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <ul class="p-0 m-0">
                            ...
                            <li class="d-flex mb-4 pb-1">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ asset('admin') }}/assets q q/img/icons/unicons/wallet.png" alt="User"
                                        class="rounded" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex mb-4 pb-1">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ asset('themes') }}/admin/img/icons/unicons/cc-success.png" alt="User"
                                        class="rounded" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex mb-4 pb-1">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ asset('themes') }}/admin/img/icons/unicons/wallet.png" alt="User"
                                        class="rounded" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                                ...
                                <div class="timeline-event">
                                    ...
                                    <div class="d-flex">
                                        <a href="javascript:void(0)" class="d-flex align-items-center me-3">
                                            <img src="{{ asset('admin') }}/assets/img/icons/misc/pdf.png" alt="PDF image"
                                                width="23" class="me-2" />
                                ...
                                <div class="timeline-event pb-0">
                                    ...
                                    <div class="d-flex align-items-center avatar-group">
                                        ...
                                        <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                            ...
                                            <img src="{{ asset('themes') }}/admin/img/avatars/12.png" alt="Avatar"
                                                class="rounded-circle" />
                                        </div>
                                        <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                            data-bs-placement="top" title="Jimmy Jackson">
                                            <img src="{{ asset('themes') }}/admin/img/avatars/9.png" alt="Avatar"
                                                class="rounded-circle" />
                                        </div>
                                        <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        ...
                                        <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                            ...
                                            <img src="{{ asset('themes') }}/admin/img/avatars/14.png" alt="Avatar"
                                                class="rounded-circle" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="table table-borderless text-nowrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('themes') }}/admin/img/icons/brands/chrome.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('themes') }}/admin/img/icons/brands/safari.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('themes') }}/admin/img/icons/brands/firefox.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('themes') }}/admin/img/icons/brands/edge.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('themes') }}/admin/img/icons/brands/opera.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('themes') }}/admin/img/icons/brands/brave.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('themes') }}/admin/img/icons/brands/vivaldi.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('themes') }}/admin/img/icons/brands/uc.png"
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('themes') }}/admin/img/icons/brands/windows.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('themes') }}/admin/img/icons/brands/mac.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('themes') }}/admin/img/icons/brands/ubuntu.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('themes') }}/admin/img/icons/brands/cent.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('themes') }}/admin/img/icons/brands/linux.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('themes') }}/admin/img/icons/brands/fedora.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('themes') }}/admin/img/icons/brands/vivaldi-os.png"
                                                        alt="Vivaldi" height="24" class="me-2" />
                                                    <span>Vivaldi</span>
                                                </div>
                                            </td>
