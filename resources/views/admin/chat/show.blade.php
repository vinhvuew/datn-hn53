            ...
            <div id="chat-box" class="p-3 rounded-4 shadow-sm"
                ...
                @foreach ($messages as $message)
                    ...
                    <div class="d-flex mb-2 {{ $isAdmin ? 'justify-content-end' : 'justify-content-start' }}">
                        <div class="d-flex {{ $isAdmin ? 'flex-row-reverse' : '' }} align-items-end gap-2">
                            <div class="rounded-circle d-flex justify-content-center align-items-center text-white fw-bold"
                                style="width: 36px; height: 36px; font-size: 0.85rem; background: {{ $isAdmin ? '#42a5f5' : '#66bb6a' }};">
                                {{ $initial }}
                            </div>
                            ...
                            font-size: 0.95rem;
                        ">
                                <div class="fw-semibold mb-1 {{ $isAdmin ? 'text-primary' : 'text-success' }}">
                                    {{ $name }}:
                                </div>
